...
namespace Class_Student_hw_25_06_2024
{
    internal class Student : IPrint
    {
        ...
        public Student(string name, string secondname, string lastname, DateTime birthday) : this(name, secondname, lastname, new DateTime(2022, 12, 12), new List<ushort>(), new List<ushort>(), new List<ushort>()) { }
